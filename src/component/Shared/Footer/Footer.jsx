      ...
      <div className="bg-black ">
        <footer className="footer p-10 text-base-content grid lg:grid-cols-4 md:grid-cols-2">
          ...
          <div>
            ...
            <a className="link link-hover">Write With Us</a>
          ...
          <div>
            ...
            <a className="link link-hover">Know Your Gold</a>
            <a className="link link-hover">Know Your Diamond</a>
            <a className="link link-hover">Know Your Gemstone</a>
            <a className="link link-hover">Ring Size Guide</a>
        ...
        <footer className="mt-2 pb-5">
          <div>
            <div className=" flex justify-center items-center gap-5">
              Social Networks -{' '}
              <a>
                <i className="fa-brands fa-twitter text-3xl text-red-600"></i>
              </a>
              <a>
                <i className="fa-brands fa-youtube text-3xl text-red-600"></i>
              </a>
              <a>
                <i className="fa-brands fa-facebook-f text-3xl text-red-600"></i>
              </a>
            </div>
          </div>
        </footer>
