  ...
  return (
    <div className="mt-20 mb-20 text-black container mx-auto">
      <div className="detail-content flex justify-center align-items-center">
        {/* detail 1 */}
        <div className="detail-input flex justify-center align-items-center  basis-5/12 flex-col gap-5 ">
          <input
            type="text"
        ...
        {/* detail 2 */}
        <div className="detail-card flex justify-center align-items-center  mx-auto basis-3/6">
          {/* details-text */}
